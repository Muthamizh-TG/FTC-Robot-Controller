...
@TeleOp
@Config
public class FullDriveNew extends LinearOpMode {

    public static double PICKPOSITION = -3050;
    ...
    private Servo angler, claw, anglerReplacement;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        anglerReplacement = hardwareMap.get(Servo.class, "anglerReplacement");
